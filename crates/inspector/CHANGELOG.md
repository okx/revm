...
## [21.0.4](https://github.com/bluealloy/revm/compare/revm-inspector-v21.0.3...revm-inspector-v21.0.4) - 2026-06-02

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-database, revm-context, revm-interpreter, revm-handler
