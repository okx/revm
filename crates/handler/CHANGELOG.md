...
## [20.0.4](https://github.com/bluealloy/revm/compare/revm-handler-v20.0.3...revm-handler-v20.0.4) - 2026-06-02

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-database, revm-context-interface, revm-context, revm-interpreter, revm-precompile
