...
## [18.0.4](https://github.com/bluealloy/revm/compare/revm-context-v18.0.3...revm-context-v18.0.4) - 2026-06-02

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-database, revm-context-interface
