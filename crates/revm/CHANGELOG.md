...
## [40.0.4](https://github.com/bluealloy/revm/compare/revm-v40.0.3...revm-v40.0.4) - 2026-06-02

### Other

- updated the following local packages: revm-state, revm-database-interface, revm-database, revm-context-interface, revm-context, revm-interpreter, revm-precompile, revm-handler, revm-inspector, revm-statetest-types
